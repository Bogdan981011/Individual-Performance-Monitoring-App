...
<body>
    ...
    <div class="container">
        ...
        <div class="option-section">
            <a href="../../section_perf_globale.php?id_eq=<?= $result['id_equipe'] ?>" class="btn-option">Performance Globale</a>            <a href="joueurs_espoirs.php" class="btn-option">Liste des joueurs</a>
