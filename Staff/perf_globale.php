...
<body>
    ...
    <div class="header-ruban">
        <div class="ruban-section">
            ...
            ?>
                <a href="perf_globale.php?id_eq=<?= $equipe['id_equipe'] ?>"
    ...
    <div class="option-section">
        <a href="entrer_don/pg_entrer_don.php?id_eq=<?= $id_equipe ?>" class="btn-option">Entrer Données</a>
        <a href="stats/pg_stats.php?id_eq=<?= $id_equipe ?>" class="btn-option">Statistiques</a>
    </div>
